...
# CPUNK Node Status Report Collection Script (Production Version)
# Generates node-status-report.json with delegation statistics
# For production server automatic updates

# Configuration
JSON_FILE="/var/www/cpunk.io/stats/node-status-report.json"
TEMP_DIR="/tmp/cpunk-node-stats"
LOG_FILE="/var/log/cpunk-node-stats.log"
