> **ARCHIVED 2026-04-24** — BFT shipped long ago (`Completed In: v0.2.0`). Current BFT lives in nodus witness server (see `dnac/CLAUDE.md` §Witness System). F17 committee enforcement extended it in v0.15.1. Kept for history.
