...
OpenDHT data has limited lifetime:

- Default TTL is ~30 minutes for mutable data
- Even "permanent" puts require republishing
- If sender goes offline, recipient may never receive payment
