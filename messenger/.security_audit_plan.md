...
- [ ] Map core directories: src/, dht/, messenger/, transport/, crypto/, database/
...
**Files to examine:**
- `/opt/dna-messenger/src/**/*.{c,h}` - Core engine code
- `/opt/dna-messenger/messenger/**/*.{c,h}` - Messaging/config/storage
- Wallet data storage
...
**Search Patterns:**
- Flutter/Dart input handling in `dna_messenger_flutter/lib/`
...
**Files to examine:**
- `/opt/dna-messenger/dna_messenger_flutter/lib/**/*.dart` - Flutter UI input
- `/opt/dna-messenger/messenger/**/*.{c,h}` - message handling
- P2P message parsing: `/opt/dna-messenger/transport/**/*.{cpp,h,c}`

**Specific Checks:**
- [ ] Buffer overflow from user input fields
...
- `/opt/dna-messenger/messenger/**/*.{c,h}` - identity management
- `/opt/dna-messenger/dna_messenger_flutter/lib/**/*.dart` - auth UI
...
- SQLite version
- Flutter/Dart dependency versions
- libsodium / OpenSSL versions

**Files to examine:**
- `/opt/dna-messenger/CMakeLists.txt` (root)
- `/opt/dna-messenger/crypto/CMakeLists.txt`
- `/opt/dna/nodus/CMakeLists.txt`
- `/opt/dna-messenger/dna_messenger_flutter/pubspec.yaml`
