...
class WalletSettingsState {
  ...
  const WalletSettingsState({this.hideZeroBalances = false, this.hideBalances = false});

  WalletSettingsState copyWith({bool? hideZeroBalances, bool? hideBalances}) => WalletSettingsState(
