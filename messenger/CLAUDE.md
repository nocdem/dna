...
**Versions:** Library v0.9.94 | Flutter v1.0.0-rc58 | Nodus v0.9.15
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.94 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc58+10408 | Flutter/Dart changes |
