...
**Versions:** Library v0.9.68 | Flutter v1.0.0-rc33 | Nodus v0.6.6
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.68 | C code changes (src/, dht/, messenger/, transport/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc33+10383 | Flutter/Dart code changes (lib/, assets/) |
