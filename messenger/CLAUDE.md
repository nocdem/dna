...
**Versions:** Library v0.9.54 | Flutter v1.0.0-rc20 | Nodus v0.6.3
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.54 | C code changes (src/, dht/, messenger/, transport/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc20+10370 | Flutter/Dart code changes (lib/, assets/) |
