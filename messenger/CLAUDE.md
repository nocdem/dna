...
**Versions:** Library v0.9.76 | Flutter v1.0.0-rc39 | Nodus v0.9.1
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.76 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc39+10389 | Flutter/Dart changes |
| Nodus | `../nodus/include/nodus/nodus_types.h` | v0.9.1 | Nodus changes |
