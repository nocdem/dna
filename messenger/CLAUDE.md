...
**Last Updated:** 2026-04-01 | **Status:** BETA | **Phase:** 7 (Flutter UI)

**Versions:** Library v0.9.156 | Flutter v1.0.0-rc140 | Nodus v0.9.26
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.156 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc140+10490 | Flutter/Dart changes |
