...
**Versions:** Library v0.9.129 | Flutter v1.0.0-rc91 | Nodus v0.9.20
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.129 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc91+10441 | Flutter/Dart changes |
