...
**Versions:** Library v0.10.6 | Flutter v1.0.0-rc207 | Nodus v0.12.9
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.10.6 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc207+10558 | Flutter/Dart changes |
