...
**Versions:** Library v0.9.111 | Flutter v1.0.0-rc69 | Nodus v0.9.15
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.111 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc69+10412 | Flutter/Dart changes |
