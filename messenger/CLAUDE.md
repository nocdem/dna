...
**Versions:** Library v0.9.157 | Flutter v1.0.0-rc143 | Nodus v0.9.26
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.157 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc143+10493 | Flutter/Dart changes |
