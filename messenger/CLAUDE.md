...
**Versions:** Library v0.9.98 | Flutter v1.0.0-rc59 | Nodus v0.9.15
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.98 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc59+10409 | Flutter/Dart changes |
