...
**Versions:** Library v0.10.7 | Flutter v1.0.0-rc209 | Nodus v0.12.9
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.10.7 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc209+10560 | Flutter/Dart changes |
| Nodus | `../nodus/include/nodus/nodus_types.h` | v0.12.9 | Nodus changes |
