...
**Versions:** Library v0.9.89 | Flutter v1.0.0-rc57 | Nodus v0.9.15
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.88 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc57+10407 | Flutter/Dart changes |
