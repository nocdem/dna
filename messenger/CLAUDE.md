...
**Versions:** Library v0.9.69 | Flutter v1.0.0-rc34 | Nodus v0.6.16
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.69 | C code changes (src/, dht/, messenger/, transport/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc34+10384 | Flutter/Dart code changes (lib/, assets/) |
| Nodus | `../nodus/include/nodus/nodus_types.h` | v0.6.16 | Nodus code changes (../nodus/) |
