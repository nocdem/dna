...
**Versions:** Library v0.9.130 | Flutter v1.0.0-rc92 | Nodus v0.9.20
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.130 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc92+10442 | Flutter/Dart changes |
