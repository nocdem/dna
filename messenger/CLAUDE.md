...
**Versions:** Library v0.9.119 | Flutter v1.0.0-rc77 | Nodus v0.9.18
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.119 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc77+10425 | Flutter/Dart changes |
