...
**Versions:** Library v0.9.128 | Flutter v1.0.0-rc90 | Nodus v0.9.20
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.128 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc90+10440 | Flutter/Dart changes |
