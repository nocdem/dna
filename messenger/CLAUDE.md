...
**Versions:** Library v0.9.123 | Flutter v1.0.0-rc84 | Nodus v0.9.20
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.123 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc84+10434 | Flutter/Dart changes |
