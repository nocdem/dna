...
**Versions:** Library v0.9.126 | Flutter v1.0.0-rc88 | Nodus v0.9.20
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.126 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc88+10438 | Flutter/Dart changes |
| Nodus | `../nodus/include/nodus/nodus_types.h` | v0.9.20 | Nodus changes |
