...
**Versions:** Library v0.9.63 | Flutter v1.0.0-rc29 | Nodus v0.6.6
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.63 | C code changes (src/, dht/, messenger/, transport/, crypto/, include/) |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc29+10379 | Flutter/Dart code changes (lib/, assets/) |
