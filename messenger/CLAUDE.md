...
**Versions:** Library v0.9.105 | Flutter v1.0.0-rc63 | Nodus v0.9.15
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.105 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc63+10412 | Flutter/Dart changes |
