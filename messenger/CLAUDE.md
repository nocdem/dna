...
**Versions:** Library v0.9.84 | Flutter v1.0.0-rc53 | Nodus v0.9.15
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.84 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc53+10403 | Flutter/Dart changes |
