...
**Versions:** Library v0.9.127 | Flutter v1.0.0-rc89 | Nodus v0.9.20
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.127 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc89+10439 | Flutter/Dart changes |
