...
**Versions:** Library v0.9.121 | Flutter v1.0.0-rc80 | Nodus v0.9.19
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.121 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc80+10430 | Flutter/Dart changes |
| Nodus | `../nodus/include/nodus/nodus_types.h` | v0.9.19 | Nodus changes |
