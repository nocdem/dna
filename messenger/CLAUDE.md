...
**Versions:** Library v0.9.193 | Flutter v1.0.0-rc197 | Nodus v0.10.42
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.9.193 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc197+10547 | Flutter/Dart changes |
| Nodus | `../nodus/include/nodus/nodus_types.h` | v0.10.42 | Nodus changes |
