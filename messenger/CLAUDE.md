...
**Versions:** Library v0.10.8 | Flutter v1.0.0-rc210 | Nodus v0.12.9
...
|-----------|--------------|---------|-----------|
| C Library | `include/dna/version.h` | v0.10.8 | C code changes |
| Flutter App | `dna_messenger_flutter/pubspec.yaml` | v1.0.0-rc210+10561 | Flutter/Dart changes |
