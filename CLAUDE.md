...
| ZK stack | `cd shared/crypto/zk && make test` | Standalone Makefile. **Status, slice history, pins and handoff live in `shared/crypto/zk/RESUME.md`** — read that, not this table. |
