...
static void test_create_channel(void) {
    ...
    if (nodus_channel_create(&store, test_uuid, false, NULL, NULL, false) != 0) {
...
static void test_ordering_by_received_at(void) {
    ...
    nodus_channel_create(&store, test_uuid, false, NULL, NULL, false);
...
static void test_migration_from_old_schema(void) {
    ...
    int rc = nodus_channel_create(&store, mig_uuid, false, NULL, NULL, false);
